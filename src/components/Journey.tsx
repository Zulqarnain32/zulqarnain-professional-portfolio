...
const Journey = () => {
  return (
    <section id="about" className="py-12 md:py-24 bg-background text-foreground transition-colors duration-300 relative overflow-hidden border-t border-border/10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-12 items-stretch">
          ...
          <div className="bg-custom-gray/60 dark:bg-custom-gray/40 border border-border backdrop-blur-sm rounded-[2rem] p-8 md:p-10 flex flex-col justify-start">
            ...
            <div className="flex items-center gap-4 border-b border-border/30 pb-6 mb-8">
              ...
              <h3 className="text-xl md:text-2xl font-extrabold md:font-bold 2xl:font-extrabold tracking-tight text-foreground font-sans">
                Education
              </h3>
            </div>
