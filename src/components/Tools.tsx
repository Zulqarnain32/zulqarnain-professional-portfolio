...
const toolsData = [
  {
    ...
    glowClass:
      "hover:shadow-[0_0_25px_rgba(97,218,251,0.35)] hover:border-[#61DAFB]/40",
  },
  {
    name: "Next.js",
    percentage: "90%",
    ...
    glowClass:
      "hover:shadow-[0_0_25px_rgba(150,150,150,0.25)] hover:border-foreground/30",
  },
  {
    name: "JavaScript",
    percentage: "90%",
    ...
    glowClass:
      "hover:shadow-[0_0_25px_rgba(247,223,30,0.35)] hover:border-[#F7DF1E]/40",
  },
  {
    name: "TypeScript",
    percentage: "92%",
    ...
    glowClass:
      "hover:shadow-[0_0_25px_rgba(49,120,198,0.35)] hover:border-[#3178C6]/40",
  },
  {
    name: "Redux",
    percentage: "85%",
    ...
    glowClass:
      "hover:shadow-[0_0_25px_rgba(118,74,188,0.35)] hover:border-[#764ABC]/40",
  },
  {
    name: "TanStack Query",
    percentage: "88%",
    logo: (
      <svg
        role="img"
        viewBox="0 0 24 24"
        className="w-[34px] h-[34px] fill-[#FF4154]"
      >
    ...
    glowClass:
      "hover:shadow-[0_0_25px_rgba(255,65,84,0.35)] hover:border-[#FF4154]/40",
  },
  {
    name: "Node.js",
    percentage: "88%",
    logo: (
      <svg
        role="img"
        viewBox="0 0 24 24"
        className="w-[34px] h-[34px] fill-[#339933]"
      >
    ...
    glowClass:
      "hover:shadow-[0_0_25px_rgba(51,153,51,0.35)] hover:border-[#339933]/40",
  },
  {
    name: "Tailwind CSS",
    percentage: "95%",
    ...
    glowClass:
      "hover:shadow-[0_0_25px_rgba(6,182,212,0.35)] hover:border-[#06B6D4]/40",
  },
  {
    name: "MongoDB",
    percentage: "85%",
    ...
    glowClass:
      "hover:shadow-[0_0_25px_rgba(71,162,72,0.35)] hover:border-[#47A248]/40",
  },
  {
    name: "PostgreSQL",
    percentage: "85%",
    ...
    glowClass:
      "hover:shadow-[0_0_25px_rgba(51,103,145,0.35)] hover:border-[#336791]/40",
  },
  {
    name: "Redis",
    percentage: "80%",
    ...
    glowClass:
      "hover:shadow-[0_0_25px_rgba(216,44,32,0.35)] hover:border-[#D82C20]/40",
  },
  {
    name: "Prisma",
    percentage: "82%",
    logo: (
      <i className="devicon-prisma-original colored text-[34px] dark:invert"></i>
    ),
    glowClass:
      "hover:shadow-[0_0_25px_rgba(45,55,72,0.35)] hover:border-[#2D3748]/40",
  },
];
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-8 justify-items-center mt-12">
          {toolsData.map((item, index) => (
            ...
            >
              ...
              <div
                className={`w-32 sm:w-36 h-56 sm:h-47 rounded-full bg-custom-gray/60 dark:bg-custom-gray/40 border border-border/80 flex flex-col items-center justify-between py-6 px-3 transition-all duration-500 hover:-translate-y-3 hover:bg-white dark:hover:bg-background ${item.glowClass}`}
              >
                {/* Top: Logo in white circle */}
                <div className="w-16 h-16 sm:w-20 sm:h-20 shrink-0 aspect-square rounded-full bg-white dark:bg-zinc-800 shadow-md shadow-black/5 flex items-center justify-center transition-transform duration-500 group-hover:scale-110 border border-border/10">
                  {item.logo}
                </div>
              ...
              <span className="text-sm md:text-base font-semibold text-foreground/70 group-hover:text-primary dark:group-hover:text-secondary transition-colors duration-300">
                {item.name}
              </span>
            </div>
          ))}
